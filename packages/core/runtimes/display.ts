 ...
 * `codearts`, `dsh`, `traecli`, `qwen`, `qwenpaw`, `mcode`, `zeroclaw`, and `commandcode` need overrides today — every
 * other provider is a first-letter capitalization of its slug on both sides. Keep in sync with the daemon map.
 */
